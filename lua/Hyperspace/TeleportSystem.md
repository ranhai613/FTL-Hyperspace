...
___
### CanReceive ()
{: #CanReceive aria-label='Methods' }
#### boolean :CanReceive ()
{: aria-label='Methods' }

___
### CanSend ()
{: #CanSend aria-label='Methods' }
#### boolean :CanSend ()
{: aria-label='Methods' }

___
### Charged ()
{: #Charged aria-label='Methods' }
#### boolean :Charged ()
{: aria-label='Methods' }

___
### ForceReady ()
{: #ForceReady aria-label='Methods' }
#### void :ForceReady ()
{: aria-label='Methods' }

___
### GetChargedPercent ()
{: #GetChargedPercent aria-label='Methods' }
...
___
### bCanReceive
{: #bCanReceive aria-label='Fields' }
#### boolean .bCanReceive
{: aria-label='Fields' }

___
### bCanSend
{: #bCanSend aria-label='Fields' }
#### boolean .bCanSend
{: aria-label='Fields' }

___
### bSuperShields
{: #bSuperShields aria-label='Fields' }
...
___
### crewSlots
{: #crewSlots aria-label='Fields' }
#### vector\<boolean\> .crewSlots
{: aria-label='Fields' }

___
### iArmed
{: #iArmed aria-label='Fields' }
#### integer .iArmed
{: aria-label='Fields' }

___
### iNumSlots
{: #iNumSlots aria-label='Fields' }
#### integer .iNumSlots
{: aria-label='Fields' }

___
### iPreparedCrew
{: #iPreparedCrew aria-label='Fields' }
