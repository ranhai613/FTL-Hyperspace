...
### AddTexVertices ()
{: #AddTexVertices aria-label='StaticMethods' }
...
___
### GL_BlitImage ()
{: #GL_BlitImage aria-label='StaticMethods' }
...
___
### GL_BlitImagePartial ()
{: #GL_BlitImagePartial aria-label='StaticMethods' }
...
{: #GL_BlitMultiColorImage aria-label='StaticMethods' }
...
___
### GL_BlitMultiImage ()
{: #GL_BlitMultiImage aria-label='StaticMethods' }
...
___
### GL_BlitPixelImage ()
{: #GL_BlitPixelImage aria-label='StaticMethods' }
...
{: #GL_BlitPixelImageWide aria-label='StaticMethods' }
...
___
### GL_ClearAll ()
{: #GL_ClearAll aria-label='StaticMethods' }
#### void .GL_ClearAll ()
{: aria-label='StaticMethods' }
...
___
### GL_ClearColor ()
{: #GL_ClearColor aria-label='StaticMethods' }
#### void .GL_ClearColor ()
{: aria-label='StaticMethods' }

___
### GL_CreateImagePrimitive ()
{: #GL_CreateImagePrimitive aria-label='StaticMethods' }
...
{: #GL_CreateMultiImagePrimitive aria-label='StaticMethods' }
...
{: #GL_CreateMultiLinePrimitive aria-label='StaticMethods' }
...
{: #GL_CreateMultiRectPrimitive aria-label='StaticMethods' }
...
{: #GL_CreatePixelImagePrimitive aria-label='StaticMethods' }
...
{: #GL_CreateRectOutlinePrimitive aria-label='StaticMethods' }
...
{: #GL_CreateRectPrimitive aria-label='StaticMethods' }
...
___
### GL_DestroyPrimitive ()
{: #GL_DestroyPrimitive aria-label='StaticMethods' }
#### void .GL_DestroyPrimitive ([GL_Primitive](../Graphics/GL_Primitive) primitive)
{: aria-label='StaticMethods' }

___
### GL_DisableBlend ()
{: #GL_DisableBlend aria-label='StaticMethods' }
#### boolean .GL_DisableBlend ()
{: aria-label='StaticMethods' }

___
### GL_DrawCircle ()
{: #GL_DrawCircle aria-label='StaticMethods' }
...
___
### GL_DrawEllipse ()
{: #GL_DrawEllipse aria-label='StaticMethods' }
...
___
### GL_DrawLaser ()
{: #GL_DrawLaser aria-label='StaticMethods' }
...
___
### GL_DrawLine ()
{: #GL_DrawLine aria-label='StaticMethods' }
...
___
### GL_DrawRect ()
{: #GL_DrawRect aria-label='StaticMethods' }
...
___
### GL_DrawRectOutline ()
{: #GL_DrawRectOutline aria-label='StaticMethods' }
...
___
### GL_DrawShield ()
{: #GL_DrawShield aria-label='StaticMethods' }
...
___
### GL_DrawTriangle ()
{: #GL_DrawTriangle aria-label='StaticMethods' }
...
___
### GL_EnableBlend ()
{: #GL_EnableBlend aria-label='StaticMethods' }
#### boolean .GL_EnableBlend ()
{: aria-label='StaticMethods' }

___
### GL_GetColor ()
{: #GL_GetColor aria-label='StaticMethods' }
#### [GL_Color](../Graphics/GL_Color) .GL_GetColor ()
{: aria-label='StaticMethods' }

___
### GL_LoadIdentity ()
{: #GL_LoadIdentity aria-label='StaticMethods' }
#### integer .GL_LoadIdentity ()
{: aria-label='StaticMethods' }

___
### GL_OrthoProjection ()
{: #GL_OrthoProjection aria-label='StaticMethods' }
#### integer .GL_OrthoProjection (number mx1, number mx2, number mx3, number mx4, number mx5, number mx6)
{: aria-label='StaticMethods' }

___
### GL_PopMatrix ()
{: #GL_PopMatrix aria-label='StaticMethods' }
...
___
### GL_PopScissor ()
{: #GL_PopScissor aria-label='StaticMethods' }
#### void .GL_PopScissor ()
{: aria-label='StaticMethods' }

___
### GL_PopStencilMode ()
{: #GL_PopStencilMode aria-label='StaticMethods' }
#### void .GL_PopStencilMode ()
{: aria-label='StaticMethods' }

___
### GL_PushMatrix ()
{: #GL_PushMatrix aria-label='StaticMethods' }
