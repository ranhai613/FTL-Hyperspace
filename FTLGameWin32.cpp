...
namespace _func225
{
    static void *func = 0;
	static short argdata[] = {0x101, 0x1ff};
	static FunctionDefinition funcObj("ChoiceBox::KeyDown", typeid(bool (ChoiceBox::*)(SDLKey )), ".8b15????????31c056", argdata, 2, 1, &func);
}
...
namespace _func226
{
    static void *func = 0;
	static short argdata[] = {0x101};
	static FunctionDefinition funcObj("ChoiceBox::GetPotentialChoice", typeid(int (ChoiceBox::*)()), ".8b4158c3", argdata, 1, 1, &func);
}

int ChoiceBox::GetPotentialChoice()
{
	typedef int __attribute__((thiscall)) (*custom_arg_funcptr_t)(ChoiceBox *this_arg);
...
namespace _func227
{
    static void *func = 0;
	static short argdata[] = {0x101, 0x1ff, 0x1ff, 0x1ff};
	static FunctionDefinition funcObj("ChoiceBox::SetChoices", typeid(void (ChoiceBox::*)(std::string *, std::vector<ChoiceText> *, std::vector<ChoiceText> *)), "578d7c240883e4f0ff77fc5589e557565389cb81ec3c0200008b", argdata, 4, 5, &func);
}

void ChoiceBox::SetChoices(std::string *mainText, std::vector<ChoiceText> *newChoices, std::vector<ChoiceText> *choicesSecond)
{
	typedef void __attribute__((thiscall)) (*custom_arg_funcptr_t)(ChoiceBox *this_arg, std::string *mainText_arg, std::vector<ChoiceText> *newChoices_arg, std::vector<ChoiceText> *choicesSecond_arg);
...
namespace _func317
{
    static void *func = 0;
	static short argdata[] = {0x101, 0x1ff, 0x1ff};
	static FunctionDefinition funcObj("ControlsScreen::MouseMove", typeid(void (ControlsScreen::*)(int , int )), ".578d7c240883e4f0ff77fc5589f889e557565389cf8d9990030000", argdata, 3, 5, &func);
}

void ControlsScreen::MouseMove(int mX, int mY)
{
	typedef void __attribute__((thiscall)) (*custom_arg_funcptr_t)(ControlsScreen *this_arg, int mX_arg, int mY_arg);
...
namespace _func318
{
    static void *func = 0;
	static short argdata[] = {0x101, 0x1ff, 0x1ff};
	static FunctionDefinition funcObj("ControlsScreen::MouseClick", typeid(void (ControlsScreen::*)(int , int )), ".578d7c240883e4f0ff77fc5589e557565389cb83ec1c80b928010000", argdata, 3, 5, &func);
}

void ControlsScreen::MouseClick(int mX, int mY)
{
	typedef void __attribute__((thiscall)) (*custom_arg_funcptr_t)(ControlsScreen *this_arg, int mX_arg, int mY_arg);
...
namespace _func756
{
    static void *func = 0;
	static short argdata[] = {0x101};
	static FunctionDefinition funcObj("OptionsScreen::Close", typeid(void (OptionsScreen::*)()), "5589e55383e4f083ec10a1????????83", argdata, 1, 5, &func);
}
...
namespace _func759
{
    static void *func = 0;
	static short argdata[] = {0x101};
	static FunctionDefinition funcObj("OptionsScreen::CheckSelection", typeid(void (OptionsScreen::*)()), ".578d7c240883e4f0ff77fc5589e5575389cb83ec10e8????????85c078", argdata, 1, 5, &func);
}
...
namespace _func761
{
    static void *func = 0;
	static short argdata[] = {0x101, 0x1ff};
	static FunctionDefinition funcObj("OptionsScreen::KeyDown", typeid(bool (OptionsScreen::*)(SDLKey )), ".578d7c240883e4f0ff77fc5589e557565389ce83ec1c0fb6", argdata, 2, 1, &func);
}

bool OptionsScreen::KeyDown(SDLKey sym)
{
	typedef bool __attribute__((thiscall)) (*custom_arg_funcptr_t)(OptionsScreen *this_arg, SDLKey sym_arg);
...
namespace _func762
{
    static void *func = 0;
	static short argdata[] = {0x101};
	static FunctionDefinition funcObj("OptionsScreen::OnRender", typeid(void (OptionsScreen::*)()), ".578d7c240883e4f0ff77fc5589e557565389cb83ec6c80b9340a0000", argdata, 1, 5, &func);
}
...
namespace _func763
{
    static void *func = 0;
	static short argdata[] = {0x101, 0x1ff, 0x1ff};
	static FunctionDefinition funcObj("OptionsScreen::MouseMove", typeid(void (OptionsScreen::*)(int , int )), ".578d7c240883e4f0ff77fc5589e557565389ce83ec5c80b9340a0000", argdata, 3, 5, &func);
}

void OptionsScreen::MouseMove(int mX, int mY)
{
	typedef void __attribute__((thiscall)) (*custom_arg_funcptr_t)(OptionsScreen *this_arg, int mX_arg, int mY_arg);
...
namespace _func764
{
    static void *func = 0;
	static short argdata[] = {0x101, 0x1ff, 0x1ff};
	static FunctionDefinition funcObj("OptionsScreen::MouseClick", typeid(void (OptionsScreen::*)(int , int )), ".578d7c240883e4f0ff77fc5589e557565383ec7c80", argdata, 3, 5, &func);
}

void OptionsScreen::MouseClick(int mX, int mY)
{
	typedef void __attribute__((thiscall)) (*custom_arg_funcptr_t)(OptionsScreen *this_arg, int mX_arg, int mY_arg);
...
namespace _func880
{
    static void *func = 0;
	static const short *argdata = NULL;
	static FunctionDefinition funcObj("Settings::ToggleVSync", typeid(void (*)()), ".5589e583e4f083ec100fb605", argdata, 0, 4, &func);
}
...
namespace _func881
{
    static void *func = 0;
	static const short *argdata = NULL;
	static FunctionDefinition funcObj("Settings::ToggleFullScreen", typeid(void (*)()), ".a????????0ba00000000", argdata, 0, 4, &func);
}
...
namespace _func886
{
    static void *func = 0;
	static const short *argdata = NULL;
	static FunctionDefinition funcObj("Settings::SaveSettings", typeid(void (*)()), ".8d4c240483e4f0ff71fc5589e5575653518d", argdata, 0, 6, &func);
}
...
namespace _func1167
{
    static void *func = 0;
	static short argdata[] = {0x101};
	static FunctionDefinition funcObj("SlideBar::OnRender", typeid(void (SlideBar::*)()), "55660fefdb660fefd289", argdata, 1, 5, &func);
}

void SlideBar::OnRender()
{
	typedef void __attribute__((thiscall)) (*custom_arg_funcptr_t)(SlideBar *this_arg);
...
namespace _func1168
{
    static void *func = 0;
	static short argdata[] = {0x101, 0x1ff, 0x1ff};
	static FunctionDefinition funcObj("SlideBar::MouseClick", typeid(void (SlideBar::*)(int , int )), ".578d7c240883e4f0ff77fc5589e5575389cb83ec2080", argdata, 3, 5, &func);
}

void SlideBar::MouseClick(int mX, int mY)
{
	typedef void __attribute__((thiscall)) (*custom_arg_funcptr_t)(SlideBar *this_arg, int mX_arg, int mY_arg);
...
namespace _func1173
{
    static void *func = 0;
	static short argdata[] = {0x101};
	static FunctionDefinition funcObj("SoundControl::GetMusicVolume", typeid(float (SoundControl::*)()), "660fefc083ec04f30f2a4124f30f5e05????????f30f110424d9042483c404c3", argdata, 1, 1, &func);
}

float SoundControl::GetMusicVolume()
{
	typedef float __attribute__((thiscall)) (*custom_arg_funcptr_t)(SoundControl *this_arg);
...
namespace _func1174
{
    static void *func = 0;
	static short argdata[] = {0x101};
	static FunctionDefinition funcObj("SoundControl::GetSoundVolume", typeid(float (SoundControl::*)()), ".660fefc083ec04f30f2a4128f30f5e05????????f30f110424d9042483c404c3", argdata, 1, 1, &func);
}
